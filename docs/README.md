...
- [operations/](operations/regras-de-negocio.md) — regras de negócio, segurança, validação, reset, [backup lógico cifrado em R2](operations/backup-r2.md), [segredos dos jobs `pg_cron`](operations/segredos-cron.md).
