...
- [ ] Instalar ou localizar `pg_dump` e `pg_restore` e confirmar que ambos são resolvidos no ambiente que executará a tarefa agendada. A checagem atual não os encontrou no PATH.
