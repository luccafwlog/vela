...
- [2026-09-22 — Remediação da auditoria do Portal e da superfície F12](2026-09-22-plano-remediacao-auditoria-portal-f12.md) — logout fail-closed, uploads/metadata de Dispute, recuperação sem canal temporal, build e supply chain, com prova de runtime autorizada.
