...
- [2026-09-20 — Remediação da fronteira de segurança do Portal](2026-09-20-remediacao-fronteira-seguranca-portal.md) — guards NULL-safe, minimização de dados, revogação fail-closed, login sem enumeração e filtros PostgREST seguros.
