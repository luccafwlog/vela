...
const ALERT_RULES_BASE = [
  ...
  },
  {
    ...
    entityType: 'bl',
    severity: 'critical',
    summary: 'O B/L tem cliente sem Portal pronto, e o cadastro não possui um e-mail de contato utilizável.',
    trigger: 'Cliente vinculado ao B/L, sem Portal pronto e sem contato com e-mail preenchido. Com Portal pronto, o e-mail não é exigido.',
    timing: 'Aparece durante a revisão pendente e some quando um e-mail válido é cadastrado ou o Portal fica pronto.',
